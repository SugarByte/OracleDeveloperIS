...
✔ Предимства: Гарантира правилна структура; Автоматизирана проверка

🔹 1.2. Бизнес валидации (в SQL/PLSQL)
...
✅ Най-добра практика:
 Комбинация от: XSD (структура) и SQL/PLSQL (бизнес логика)
...
🔹 Вариант 3: MERGE (idempotent processing): Позволява повторно зареждане без дублиране
